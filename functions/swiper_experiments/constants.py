...
class Text:
    ...
    HELLO = (
        ...
        "\n"
        "<i>P. S. Якщо я раптом надокучатиму, Телеграм дозволяє вимкнути мої сповіщення тимчасово або ж назавжди.</i>\n"
        "\n"
        f"Докладніше: /{Commands.READ_MORE}\n"
    )
    HELP = (
        "👋 Привіт, мене звати Свайпі🙃\n"
        "\n"
    ...
    READ_MORE = 'https://toporok.medium.com/як-swipy-працює-зараз-404d70a64cfb'

    TALK_NOT_FOUND = '💔 Розмову не знайдено'
    TALK_STOPPED = '🚧 Ця функція поки що не реалізована'

    NEW_TOPIC_STARTED = f"Ви створили нову тему для розмов - очікуйте відповідей ⏳\n\nДопомога: /{Commands.HELP}"
