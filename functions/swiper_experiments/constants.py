...
class Text:
    HELP = (
        ...
        "\n"
        "Або ж просто залишайтесь на зв`язку та при бажанні відповідайте на повідомлення-теми, що надходитимуть.\n"
        "\n"
        "Щоб відповісти на повідомлення, проведіть по ньому пальцем вліво⬅️ або скористайтесь опцією \"Відповісти\".\n"
        "\n"
